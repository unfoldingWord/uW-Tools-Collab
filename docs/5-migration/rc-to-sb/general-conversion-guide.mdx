...
This guide gives step-by-step instructions to convert Resource Container repositories to Scripture Burrito format. The conversion is feasible. It requires careful handling of structural differences and some data transformation.

**Conversion Feasibility**: ✅ **HIGHLY FEASIBLE**
**Complexity Level**: Low to Medium
**Recommended Approach**: Automated conversion with validation
**Key Insight**: Scripture Burrito is more flexible than the first assessment showed

## Enhanced Understanding of Scripture Burrito Flexibility

### Key Research Findings

Research of the [Scripture Burrito specification](https://docs.burrito.bible/) shows that Scripture Burrito is more flexible than initially understood:
...
- Scope precision (book/chapter/verse level)
- Relationship modeling
- Role system for content categorization
...
Research of the [Scripture Burrito specification](https://docs.burrito.bible/) shows that the format is flexible. It can hold most RC content:
...
**Key Discovery**: Scripture Burrito's ingredient system is more flexible than Resource Container's projects array. This makes conversion easier than initially thought.
...
**Key Insight**: Scripture Burrito has specific flavor types for different biblical content. This makes RC conversion natural.
...
- `project.versification` → `scope` objects with versification info
...
- Relationship conversion (SB has relationship support)
...
- **Content Typing**: Explicit MIME types vs implicit file extension detection
- **Scope System**: Book/chapter/verse precision vs simple versification
- **Relationships**: Relationship modeling vs simple relation array
...
- **Multi-Content Resources**: Support for repositories with multiple content types
...
Research of the [Scripture Burrito specification](https://docs.burrito.bible/) shows that conversion from Resource Container to Scripture Burrito is feasible and beneficial. Scripture Burrito gives capabilities that improve on Resource Container limitations.
...
- **Precision**: More precise scope and content typing than RC
- **Organization**: Ingredients system is more flexible than RC projects
- **Relationships**: Relationship modeling vs simple RC relations
- **Future-Proof**: Designed for current Bible translation workflows
- **Tool Ecosystem**: Growing ecosystem of SB-compatible tools

**Conversion Complexity**: **Low to Medium** (easier than initially assessed)
...
1. **Automated Conversion Tool**: Build the conversion tool with mapping guidelines
2. **Validation Pipeline**: Implement SB validation for quality assurance
3. **Gradual Migration**: Convert repositories
4. **Tool Integration**: Integrate with SB-compatible applications

**Key Insight**: Scripture Burrito addresses limitations in existing formats like Resource Container. This makes it a natural evolution path for Door43 resources.

---

This guide is based on analysis of both Resource Container and Scripture Burrito specifications. Use it with the main [Door43 API Developer Guide](../../3-door43-api-developer-guide).
