...
This guide gives instructions to migrate Translation Academy Resource Containers to Scripture Burrito format. Translation Academy repositories contain training materials in nested Markdown files. These files map well to the Scripture Burrito peripheral resource capabilities.
...
- **Article Organization**: Handling of multi-file article structure
- **Cross-Referencing**: Relationship modeling to other resources
- **Explicit Content Structure**: Clear identification of article components
- **Training Workflow Support**: Support for systematic training progression
...
- Create combined Markdown structure
...
- Utilize relationship system for cross-referencing
...
**Better Than RC**:
- **Single Article Structure**: Combined articles vs three-file system
- **Metadata**: Scope information vs directory structure only
...
This migration guide is based on analysis of Translation Academy Resource Containers and [Scripture Burrito specification](https://docs.burrito.bible/) research. Use it together with the main [RC to Scripture Burrito Conversion Guide](../general-conversion-guide).
