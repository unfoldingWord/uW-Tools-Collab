...
This guide gives instructions to migrate Translation Notes Resource Containers to Scripture Burrito format. Translation Notes repositories contain verse-specific guidance in TSV format. This guidance maps well to the Scripture Burrito parascriptural capabilities.
...
- **Cross-Referencing**: Relationship modeling to source texts
...
- **Tool Integration**: Parascriptural flavor designed for notes and guidance
- **Linking**: Support for cross-references to other resources
...
- Use precise scope definitions for content targeting
- Add versification information to scope objects
- Utilize relationship system for dependency modeling
...
- **Cross-Reference Support**: Handling of rc:// links and relationships
...
This migration guide is based on analysis of Translation Notes Resource Containers and [Scripture Burrito specification](https://docs.burrito.bible/) research. Use it together with the main [RC to Scripture Burrito Conversion Guide](../general-conversion-guide).
