...
This guide shows how to integrate one translationCore (TC) book into an existing Resource Container (RC) repository. Teams use this scenario most often. They work on multiple books. They want to combine their work into one Bible translation project.
...
**Before Integration**:
- ✅ TC repository format confirmed
- ✅ Primary USFM file identified
- ✅ Target RC repository analyzed
- ✅ Integration strategy selected
- ✅ Backup created (if replacing)

**After Integration**:
- ✅ Book file correctly named and placed
- ✅ Manifest updated with new book
- ✅ USFM content validates successfully
- ✅ Alignment data preserved intact
- ✅ Dependencies mapped correctly
- ✅ RC structure remains valid
...
- ✅ **Content Preservation**: All TC USFM content exactly preserved
- ✅ **Alignment Integrity**: Word alignment data completely intact
- ✅ **RC Compliance**: Book properly integrated into RC structure
- ✅ **Manifest Accuracy**: RC manifest correctly updated
- ✅ **File Organization**: Book file follows RC naming conventions
- ✅ **Dependency Mapping**: TC dependencies correctly mapped to RC format
- ✅ **Validation Success**: RC validates with integrated book

---

**Next Steps**: After integration, use [Alignment Data Handling](alignment-data-handling) to verify alignment. You can also add more TC books with the same process.
