...
This guide is based on analysis of Door43 Translation Notes repositories and should be used alongside the main [Door43 API Developer Guide](../door43-api-developer-guide.md).
