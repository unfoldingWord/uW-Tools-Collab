...
This document gives task instructions for MCP systems. The systems analyze aspects of Door43 repositories and maintain documentation.

## Task 1: New Repository Type Discovery

### Objective
Discover new repository types or patterns that existing guides do not cover.
...
### Objective
Validate existing guides against current repository structures. Update the guides when needed.
...
### Objective
Analyze conversion patterns. Add real conversion examples to the migration guides.
...
### Expected Outputs
- Updated migration guides with real examples
...
### Objective
Analyze relationships between repositories. Update the cross-reference documentation.
...
### Objective
Track changes in repository content patterns. Update the guides.
...
- **Quarterly**: Full cross-repository pattern analysis
- **Semi-annually**: Major guide structure and content review

**Update Prioritization**:
1. **Critical**: Broken examples or incorrect API information
2. **High**: New repository types that need new guides
3. **Medium**: Improved examples or explanations
...
These MCP task specifications enable automated analysis of the Door43 ecosystem. They enable systematic maintenance of repository format guides.
