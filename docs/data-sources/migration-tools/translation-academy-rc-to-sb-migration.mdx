...
This migration guide is based on analysis of Translation Academy Resource Containers and [Scripture Burrito specification](https://docs.burrito.bible/) research, and should be used alongside the main [RC to Scripture Burrito Conversion Guide](../rc-to-scripture-burrito-conversion-guide.md).
