...
Now that you understand the mission and ecosystem, choose your learning path:

### **For Developers**
- **[unfoldingWord Developer Guide](../guides/unfoldingword-developer-guide)** - Complete technical specification of the resource ecosystem
- **[Door43 API Developer Guide](../guides/door43-api-developer-guide)** - Practical API implementation patterns

### **For Specific Resource Types**
- **[Repository Formats Overview](../repository-formats/)** - All supported formats and specifications
- **[Resource Container Guides](../repository-formats/resource-container/)** - Standard unfoldingWord formats
- **[Scripture Burrito Guides](../repository-formats/scripture-burrito/)** - Alternative Bible resource formats

### **For Format Conversion**
- **[Migration Guides](../migration/)** - Convert between Resource Container and Scripture Burrito formats
...
**Continue Reading**: [unfoldingWord Developer Guide](../guides/unfoldingword-developer-guide) - Learn the complete technical architecture