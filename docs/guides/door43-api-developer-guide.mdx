...
> **📖 Complete API Reference**: For all available endpoints, parameters, and response formats, see the [official Door43 API documentation](https://git.door43.org/api/swagger).
...
> **💡 Tip**: This section covers the most common API usage patterns. For complete endpoint specifications, query parameters, and response schemas, refer to the [official API documentation](https://git.door43.org/api/swagger).
...
- `manifest.yaml`, `manifest.yml`, or `manifest.json` → **Content inspection required**
- `metadata.json` → **Content inspection required** 
- Any manifest file → **Format determined by content structure, not file extension**

> **⚠️ Important**: File extensions don't determine the format. A `manifest.json` could contain Resource Container format, and a `manifest.yaml` could contain translationCore format. Always inspect content structure.
...
> **📝 Note**: These content structures can appear in `.yaml`, `.yml`, or `.json` files. The format is determined by the content structure, not the file extension.
...
> **📖 Detailed Guide**: For comprehensive translationCore format documentation, see [translationCore Format Guide](docs/translationcore-format-guide.md)
...
> **📖 Detailed Guide**: For comprehensive translationStudio format documentation, see [translationStudio Format Guide](docs/translationstudio-format-guide.md)
...
- **[Bible Text Repositories Guide](docs/bible-text-repositories-guide.md)** - Original language texts (UHB, UGNT) and gateway translations (ULT, UST)
- **[Translation Notes Repositories Guide](docs/translation-notes-repositories-guide.md)** - Verse-specific guidance (TN)
- **[Translation Questions Repositories Guide](docs/translation-questions-repositories-guide.md)** - Quality assurance questions (TQ)
- **[Translation Words Repositories Guide](docs/translation-words-repositories-guide.md)** - Biblical term definitions (TW)
- **[Translation Words Links Repositories Guide](docs/translation-words-links-repositories-guide.md)** - Word-to-definition cross-references (TWL)
- **[Translation Academy Repositories Guide](docs/translation-academy-repositories-guide.md)** - Training materials (TA)
- **[Open Bible Stories Repositories Guide](docs/open-bible-stories-repositories-guide.md)** - Bible overview stories (OBS, OBS-TN, OBS-TWL)

### Tool-Generated Formats
- **[translationCore Format Guide](docs/translationcore-format-guide.md)** - Single-book projects from translationCore
- **[translationStudio Format Guide](docs/translationstudio-format-guide.md)** - Chapter/story projects from translationStudio

### Alternative Specifications
- **[Scripture Burrito Repositories Guide](docs/scripture-burrito-repositories-guide.md)** - Scripture Burrito format resources

### Migration and Conversion Guides
- **[RC to Scripture Burrito Conversion Guide](docs/rc-to-scripture-burrito-conversion-guide.md)** - General conversion overview and principles
- **[Migration Guide Index](docs/migration-guides/migration-guide-index.md)** - Complete index of repository-specific migration guides

#### Repository-Specific Migration Guides
- **[Bible Text RC to SB Migration](docs/migration-guides/bible-text-rc-to-sb-migration.md)** - UHB, UGNT, ULT, UST
- **[Translation Notes RC to SB Migration](docs/migration-guides/translation-notes-rc-to-sb-migration.md)** - TN, OBS-TN
- **[Translation Words RC to SB Migration](docs/migration-guides/translation-words-rc-to-sb-migration.md)** - TW
- **[Translation Academy RC to SB Migration](docs/migration-guides/translation-academy-rc-to-sb-migration.md)** - TA

### Analysis Tools
- **[Repository Analysis Plan](docs/repository-analysis-plan.md)** - Framework for analyzing new repository types
