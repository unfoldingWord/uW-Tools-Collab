...
This guide provides detailed documentation for handling repositories created by [translationCore](https://tc-documentation.readthedocs.io/en/latest/) desktop application. 

**What is translationCore?**
translationCore is a comprehensive Bible translation checking application that provides:
...
- Rich word alignment and checking data
...
> **Note**: The working file is what translationCore actively modifies during translation checking. Any additional USFM files beyond these two are user-created, not generated by translationCore.
...
This documentation is based on analysis of real translationCore repositories including [es-419_glt_jon_book](https://git.door43.org/abelper8/es-419_glt_jon_book) and should be used alongside the main [Door43 API Developer Guide](../../3-door43-api-developer-guide).
