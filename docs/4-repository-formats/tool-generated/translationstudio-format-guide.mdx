...
This guide gives documentation to handle repositories created by the translationStudio desktop application. These repositories change in structure. The structure depends on the resource type (Bible books vs Open Bible Stories). These repositories need special processing.
...
- You now have completion information
...
- Users can navigate between numbered files
...
- The API does not always handle files without extensions correctly
