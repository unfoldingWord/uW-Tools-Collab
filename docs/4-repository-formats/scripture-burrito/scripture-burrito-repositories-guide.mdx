...
This guide describes how to handle Scripture Burrito repositories in Door43. Scripture Burrito is an alternative specification to Resource Container. It packages Bible resources with different organizational principles.
...
- Format: Multiple content types supported
...
**Problem**: A single repository can contain multiple content types
**Solution**: Process ingredients systematically and maintain clear relationships

---

This guide is based on analysis of Door43 Scripture Burrito repositories. Use it together with the main [Door43 API Developer Guide](../../3-door43-api-developer-guide).
