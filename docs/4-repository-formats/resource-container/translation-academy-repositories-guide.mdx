...
This guide shows how to handle Translation Academy repositories in Door43. These repositories contain translation training materials. The materials are nested Markdown articles. They give methodology and cultural guidance to translators.
...
- Scope: Complete translation training
...
- Build a topic cross-reference index
...
**Solution**: Build a cross-reference database

---

This guide is based on analysis of Door43 Translation Academy repositories. Use it with the main [Door43 API Developer Guide](../../3-door43-api-developer-guide).
