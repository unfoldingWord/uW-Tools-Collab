...
This guide shows how to handle Translation Notes repositories in Door43. These repositories contain verse-specific translation guidance in TSV format. The guidance helps translators understand difficult passages and translation issues.
...
├── 📄 tn_GEN.tsv                    # Genesis notes
├── 📄 tn_EXO.tsv                    # Exodus notes
├── 📄 tn_LEV.tsv                    # Leviticus notes
├── ...                              # All Bible books
├── 📄 tn_MAT.tsv                    # Matthew notes
├── ...                              # All NT books
└── 📄 tn_REV.tsv                    # Revelation notes
```
...
- Enable navigation to Translation Academy
...
This guide is based on analysis of Door43 Translation Notes repositories. Use it with the main [Door43 API Developer Guide](../../3-door43-api-developer-guide).
