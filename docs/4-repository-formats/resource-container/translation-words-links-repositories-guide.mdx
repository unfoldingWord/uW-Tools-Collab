...
This guide describes how to handle Translation Words Links repositories in Door43. These repositories contain cross-reference links between specific word occurrences in Bible texts and Translation Words definitions. The links enable precise word-level navigation and highlighting.
...
| **OrigWords** | Original language words | "בְּרֵאשִׁית" |
...
1:1	xyz1	kt	אֱלֹהִים	1	rc://*/tw/dict/bible/kt/god
1:1	xyz2	other	בְּרֵאשִׁית	1	rc://*/tw/dict/bible/other/creation
1:2	xyz3	kt	רוּחַ	1	rc://*/tw/dict/bible/kt/holyspirit
```
...
- Enable navigation from Bible words to definitions
...
**Complementary Usage**:
- Translation Notes can reference the same words
...
This guide is based on analysis of Door43 Translation Words Links repositories. Use it together with the main [Door43 API Developer Guide](../../3-door43-api-developer-guide).
