...
This guide shows how to handle Bible text repositories in Door43. It covers original language texts and gateway language translations. These repositories contain complete Bibles in USFM format. They have different levels of alignment and complexity.
...
This guide is based on analysis of Door43 Bible text repositories. Use it with the main [Door43 API Developer Guide](../../3-door43-api-developer-guide).
