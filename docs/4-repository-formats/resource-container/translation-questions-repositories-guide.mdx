...
This guide describes how to handle Translation Questions repositories in Door43. These repositories contain quality assurance questions in TSV format. The questions help translators and checkers to verify translation accuracy and comprehension.
...
- Enable navigation between questions and text
...
**Problem**: Some questions can be not applicable to all translation approaches
**Solution**: Use question tags to filter relevant questions for specific translation types

### Issue 2: Response Interpretation
**Problem**: Expected responses can be too specific or rigid
**Solution**: Treat responses as guidance rather than exact requirements

### Issue 3: Large Question Sets
**Problem**: Some books have many questions. Many questions make the review difficult.
**Solution**: Implement pagination and progress tracking for systematic review

---

This guide is based on analysis of Door43 Translation Questions repositories. Use it together with the main [Door43 API Developer Guide](../../3-door43-api-developer-guide).
