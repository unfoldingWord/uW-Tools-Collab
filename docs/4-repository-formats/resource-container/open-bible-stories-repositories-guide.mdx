...
This guide shows how to handle Open Bible Stories (OBS) repositories in Door43. These repositories contain Bible overview stories in Markdown format. They give a Bible narrative in 50 connected stories.
...
This guide is based on analysis of Door43 Open Bible Stories repositories. Use it with the main [Door43 API Developer Guide](3-door43-api-developer-guide).
